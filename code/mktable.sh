...
dchart -fulldeck=f -textsize=0.75 -pmap  -pwidth=3 -val=f -top=27 -left=50 -right=70 go-platform.d
dchart -fulldeck=f -textsize=0.75 -ls=1.5 -pgrid -top=30 -left=75 -right=90 -val=f go-platform.d # incar.d
dchart -fulldeck=f -textsize=0.75 -radial -psize=3.5 -pwidth=7 -top=20 -left=37  go-platform.d
#echo '</slide></deck>'
)
